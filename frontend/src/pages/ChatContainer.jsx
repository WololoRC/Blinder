...
const ChatContainer = ({ chat_uid, userIndex, myUserId, chatId }) => {
    ...
    <>
      ...
      >
        <div className="  z-10  text-neutral-content">
          ...
          <p
            className={
              lightMode ? "text-white text-2xl" : "text-black text-lg "
            }
          >
            {nameh1}{" "}
            <div className="absolute top-3 right-0">
              ...
              <div>
                {block && (
                  <button
                    onClick={() => setBlockOn(!blockOn)}
                    className="bg-white absolute top-4 px-2 right-0"
                  >
