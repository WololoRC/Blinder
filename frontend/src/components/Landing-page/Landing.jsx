...
import Feed from "./landing-photos/blinder4.jpg";
import Chat from "./landing-photos/blinder1.jpg";
import Tags from "./landing-photos/blinder3.jpg";
import Users from "./landing-photos/blinder2.jpg";
...
function Landing() {
  ...
  return (
    <div className="landing-container bg-epicblack">
      <header className="header-container text-fantasyli bg-epicgray">
        <h1 className="text-epicpink">Welcome to Blinder!</h1>
      </header>
      <section className="description-section">
        <div className="description-container text-epicpink bg-epicblack">
          ...
          <img className="main-image" src= { Users } alt="" />
          <img className="main-image" src= { Chat } alt="" />
        </div>
      </section>
      ...
      <section className="features-container bg-epicpink text-white">
        <Slider {...settings}>
          ...
          <div>
            <ul className="features">
              <li>User-friendly messaging system</li>
            </ul>
          </div>
        </Slider>
      </section>      
      <footer className="footer-container ">
        <h3 className="about bg-epicgray text-white">Team members</h3>
